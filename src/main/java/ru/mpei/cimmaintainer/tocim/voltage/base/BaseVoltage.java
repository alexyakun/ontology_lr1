...
public class BaseVoltage {
    public static List<RdfResource> convert(){
        ...
        RdfResource builder = new RdfResourcesBuilder(new RdfResourcesId("e6240428-fe41-4cb9-80d2-52bd2bbe2c03"), CimClasses.bVoltage)
                .addDataProperty(CimClasses.identifiedObjectCim.mRID, "e6240428-fe41-4cb9-80d2-52bd2bbe2c03")
                .addDataProperty(CimClasses.identifiedObjectCim.name, "110кВ")
                .addDataProperty(CimClasses.baseVoltageCim.nominalVoltage, "110.0")
                .builder();
        ...
        RdfResource builder1 = new RdfResourcesBuilder(new RdfResourcesId("9fd0eedd-2fbb-4160-86ba-5d577108df8d"), CimClasses.bVoltage)
                .addDataProperty(CimClasses.identifiedObjectCim.mRID, "9fd0eedd-2fbb-4160-86ba-5d577108df8d")
                .addDataProperty(CimClasses.identifiedObjectCim.name, "10кВ")
                .addDataProperty(CimClasses.baseVoltageCim.nominalVoltage, "10.0")
                .builder();
